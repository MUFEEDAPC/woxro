    ...
    <div className='services'>
      ...
      <Card className='service-card' style={{backgroundColor: '#f6f5f3'}}>
        ...
        <img src={service1} alt="" />
          <Card.Title style={{fontWeight:'700',fontSize:'24px'}}>Web Application</Card.Title>
          <Card.Text style={{fontSize:'14px',letterSpacing:'1px'}}>
      ...
      <Card className='service-card' style={{backgroundColor: '#f6f5f3'}}>
        <Card.Body>
        <img src={mobile} alt="" />
          <Card.Title style={{fontWeight:'700',fontSize:'24px'}}>Mobile App Development</Card.Title>
          <Card.Text style={{fontSize:'14px',letterSpacing:'1px'}}>
    ...
    <CardGroup>
      <Card className='service-card' style={{backgroundColor: '#fcf0e4'}}>
        ...
        <img src={ecommerce} alt="" />
          <Card.Title style={{fontWeight:'700',fontSize:'24px'}}>Ecommerce Development</Card.Title>
          <Card.Text style={{fontSize:'14px',letterSpacing:'1px'}}>
      ...
      <Card className='service-card' style={{backgroundColor: '#f5f6f8'}}>
        <Card.Body>
        <img src={digital} alt="" />
          <Card.Title style={{fontWeight:'700',fontSize:'24px'}}>Digital Marketing</Card.Title>
          <Card.Text style={{fontSize:'14px',letterSpacing:'1px'}}>
      ...
      <Card className='service-card' style={{backgroundColor: '#effbfb'}}>
        <Card.Body>
        <img src={graphic} alt="" />
          <Card.Title style={{fontWeight:'700',fontSize:'24px'}}>Graphic Designing</Card.Title>
          <Card.Text style={{fontSize:'14px',letterSpacing:'1px'}}>
          We build sustainable, brands by connecting your product and message with audiences that would want to get your and or services.
           We nurture ideas to transform ands through creativity focussed on growth. 
          </Card.Text>
        </Card.Body>
